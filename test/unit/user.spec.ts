...
describe('User actions', () => {
  describe('createUser', () => {
    beforeEach(() => {
      ...
      arrayStub = sandbox.stub(Array.prototype, "some").returns(false);
    });
    ...
    it('should create users with same access token', () => {
      ...
      assert.deepStrictEqual(resultUser1, expectedUser1);
      assert.deepStrictEqual(resultUser2, expectedUser2);
    ...
    it('should not create user if username already exists', () => {
      arrayStub.onCall(1).returns(true);
